...
@q6=Question.create({body:"Which of the following is not a Programming Language",answer:'Lionel Messi'})
...
Reply.create!({option1:'C++',option2:'Java', option3:'Ruby',option4:'Lionel Messi',selection:'Sam',question_id:6})
